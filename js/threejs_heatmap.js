...
function debugObject(lat, lng) {
    console.log("DEBUGOBJECT TODO XXX");
    ...
    var dscenecoord = [0, 0]; //XXX PORT: city.geo.projection(dgeocoord, city.geo.tileZoom);
    dcube.position.x = dscenecoord[0];
    dcube.position.y = -0.2;
    dcube.position.z = dscenecoord[1];
    dcube.scale.set(10, 100, 10);
    //XXX PORT: city.webgl.scene.addToScene(dcube);
    return dcube;
}
